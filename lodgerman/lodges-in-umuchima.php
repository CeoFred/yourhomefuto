...
<html>
<head>
	<title>Lodges in Umuchima - Lodgerman</title>
<?php
...
if (isset($_GET['Location'])) {
 ...
 ?>
		...
		<li><a href="#" style="color: black">Umuchima(<?php echo $total; ?>)Lodges </a></li>
	</ol>
	</div>
          ...
          <div class="carousel-item active">
            ...
            <a class="carousel-control-next" href="#carouselExampleIndicators"  role="button" data-slide="next">
          	...
          	<span style="margin-top: 5px;padding-left: 20px;padding-top: 20px;">
          		<p style="color:black;padding: 5px;"><i class="fa fa-home" style="font-size: 25px;"></i><?php echo $r['lodge_name']; ?>
          	</p>
          		<p style="color: black;padding: 5px;"><i class="fa fa-map-marker" style="font-size: 25px;"></i><?php echo $r['lodge_location']; ?></p>

          		<p style="color: black;padding: 5px;"><i class="fa fa-money" style="font-size: 25px;"></i><?php echo $r['price'] ?></p>
          <p class="btn-group" align="center">

          	<a href="lodge?lodge_name=<?php echo $r['lodge_name']; ?>" class="btn btn-block"
             style="background-color:#800000;border-radius: 0px;width: 100%;margin: 10px;color:#fff;"><i class="fa fa-eye"></i> View</a>

                      	<a href="share" class="btn btn-block" style="background-color:#3CB371;border-radius: 0px;width: 100%;margin: 10px;color:#fff;"><i class="fa fa-share"></i>Share</a>
