...
<a href="https://wa.me/?text=Check out lodges in Eziobodo,Futo now on yourhomefuto.com.ng/lodgerman/lodge?lodger_man_id=<?php echo($r['lodger_man_id']); ?>" class=" btn btn-success"><i class="fa fa-whatsapp"></i>Share
